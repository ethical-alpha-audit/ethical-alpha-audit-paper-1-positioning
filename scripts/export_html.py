...
Based on the Paper 4 exemplar (I5) pattern.

Converts each notebook to a static HTML file in docs/html/
so readers can browse notebooks without installing Jupyter.
"""
